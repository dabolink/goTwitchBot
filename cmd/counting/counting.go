...
func main() {
	...
	commandStore := command.NewCommandStore([]command.Command{command.NewCountCommand()})

	builder := chat.NewBotBuilder(chat.Config{CmdPrefix: "!"}, command.NewManager(commandStore), &variables.VariableManager{})
